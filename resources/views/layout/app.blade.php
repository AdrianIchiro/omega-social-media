  ...
  <nav class="bg-gray-800" x-data="{ isOpen: false }">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="{{Route('posts')}}" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Post</a>
    ...
    <div class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        ...
        <a href="{{Route('posts')}}" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Post</a>
      ...
      <div class="border-t border-gray-700 pb-3 pt-4">
        ...
        <div class="mt-3 space-y-1 px-2">
          ...
          @guest
            ...
            <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Sign in</a>
          @endguest
