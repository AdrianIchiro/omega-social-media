<x-layout>
    ...
    <header class="px-2 py-4 mt-16 flex flex-col justify-center items-center text-center">
        <img class="inline-flex object-cover border-4 border-indigo-600 rounded-full shadow-[5px_5px_0_0_rgba(0,0,0,1)] shadow-indigo-600/100 bg-indigo-50 text-indigo-600 h-24 w-24 !h-48 !w-48"
            src="https://i.pinimg.com/736x/51/3b/57/513b57e6c92b827b3e3892ff75fc87b0.jpg" alt="">
        ...
        <ul class="flex flex-row mt-2">
            <li class="mx-2">
                <a href="" target="_blank" aria-label="GitHub">
                    <svg class="h-6 text-indigo-700 hover:text-indigo-300" fill="currentColor" role="img"
    ...
    <section class="mx-52">
        <h1 class="text-3xl font-bold">My Post</h1>
